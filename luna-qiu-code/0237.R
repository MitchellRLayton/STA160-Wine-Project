...
adist(paste(train$bottle_price, collapse = " "), paste(database$price1, collapse = " "))
length(strsplit(paste(train$bottle_price, collapse = " "), "")[[1]])

adist(paste(train$case_price, collapse = " "), paste(database$price2, collapse = " "))
length(strsplit(paste(train$case_price, collapse = " "), "")[[1]])